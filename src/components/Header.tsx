      ...
      <div className="container mx-auto px-4 py-4">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-2 bg-gray-50 rounded-lg p-4">
            <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 font-medium">Products</a>
            <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 font-medium">Popular & Coming Soon</a>
            <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 font-medium">In-Game Currencies</a>
            <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 font-medium">Digital Tools</a>
            <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 font-medium">Software</a>
          </div>
        )}
      </div>
    </header>
